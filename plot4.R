...
plot(HPC2007$DateTime, HPC2007$Voltage, ylab = "Voltage", xlab = "datetime", type = "l")
...
plot(HPC2007$DateTime, HPC2007$Global_reactive_power, ylab = "Global_reactive_power", xlab = "datetime", type = "l")
